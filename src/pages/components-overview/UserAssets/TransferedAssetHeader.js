...
import TransferApproveTable from './TransferApproveTable';
import TransferRejectTable from './TransferRejectTable';
...
export default function TransferedAssetHeader() {
