...
import { getAllSoftware } from 'components/redux/software/action';
...
const Softwaretable = () => {
	...
	const AllSoftware = useSelector((state) => state.SoftwareData && state.SoftwareData.AllSoftware);
	const [selectedCategory, setSelectedCategory] = useState('Choose Asset Category');
	const [selectedAssetType, setSelectedAssetType] = useState(null);

	// const AllSoftware = useSelector((state) => state.AssetData && state.AssetData.AllSoftware);
	...
	const handleCategoryChange = (value) => {
		...
		dispatch(getAllSoftware(value, selectedAssetType));
		// setAssetTypes(AssetTypeDetails || []);
	};

	const handleAssetTypeChange = (value) => {
		setSelectedAssetType(value);
		dispatch(getAllSoftware(selectedCategory, value));
	};
	...
	React.useEffect(() => {
		...
		dispatch(getAllSoftware(selectedCategory, selectedAssetType));
	}, [dispatch]);
