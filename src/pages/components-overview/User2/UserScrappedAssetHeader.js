...
import UserPendingScrapTable from './UserPendingScrapTable';
import UserApprovedScrapTable from './UserApprovedScrapTable';
import UserRejectedScrapTable from './UserRejectedScrapTable';
...
export default function UserScrappedAssetHeader() {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <CustomTabPanel value={value} index={0} sx={{ width: '0px' }}>
        <UserPendingScrapTable />
      </CustomTabPanel>
      <CustomTabPanel value={value} index={1}>
        <UserApprovedScrapTable />
      </CustomTabPanel>
      <CustomTabPanel value={value} index={2}>
        <UserRejectedScrapTable />
      </CustomTabPanel>
    </Box>
  );
}
