...
const UserTransferPendingTable = () => {
  ...
  const AssetList = useSelector((state) => state.AssetTransferData && state.AssetTransferData.AssetTransferStatus);
...
export default UserTransferPendingTable;
