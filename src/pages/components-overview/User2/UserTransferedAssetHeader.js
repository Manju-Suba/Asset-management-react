...
import UserTransferPendingTable from './UserTransferPendingTable';
import UserTransferApprovedTable from './UserTransferApprovedTable';
import UserTransferRejectedTable from './UserTransferRejectedTable';
...
export default function UserTransferedAssetHeader() {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <CustomTabPanel value={value} index={0} sx={{ width: '0px' }}>
        <UserTransferPendingTable />
      </CustomTabPanel>
      <CustomTabPanel value={value} index={1}>
        <UserTransferApprovedTable/>
      </CustomTabPanel>
      <CustomTabPanel value={value} index={2}>
        <UserTransferRejectedTable />
      </CustomTabPanel>
    </Box>
  );
}
