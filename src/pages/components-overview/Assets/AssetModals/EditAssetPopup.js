...
import { assetUpdate, getAllAssetDetails } from 'components/redux/asset/action';

const { Option } = Select;

const Editassets = ({ AssetData, isModalOpen, setIsModalOpen }) => {
    ...
    const handleOk = () => {
        ...
        form.validateFields()
            .then((values) => {
                ...
                dispatch(assetUpdate(updatedValues))
                    .then((response) => {
    ...
    useEffect(() => {
        ...
        if (AssetData) {
            form.resetFields();
            form.setFieldsValue({
                business: AssetData.business ? AssetData.business.id : '',
                type: AssetData.type,
                assetCategory: AssetData.assetCategory ? AssetData.assetCategory.id : '',
                assetType: AssetData.assetType ? AssetData.assetType.id : '',
                name: AssetData.name,
                portNo: AssetData.portNo,
                AssetId: AssetData.assetId,
                qrcode: AssetData.qrcode,
                costCenter: AssetData.costCenter,
                location: AssetData.location ? AssetData.location.id : '',
                brand: AssetData.brand ? AssetData.brand.id : '',
                cost: AssetData.cost,
                date: AssetData.date,
                assetDomain: AssetData.assetDomain,
                spoc: AssetData.spoc ? AssetData.spoc.id : '',
                assetAllocate: AssetData.assetAllocate,
                ...
                picture: AssetData.picture,
                document: AssetData.document,
                cpuLaptopModel: AssetData.cpuLaptopModel,
                cpuLaptopConfiguration: AssetData.cpuLaptopConfiguration,
                cpuLaptopSi: AssetData.cpuLaptopSi,
                hostName: AssetData.hostName,
                ram: AssetData.ram,
                hddSdd: AssetData.hddSdd,
                mouse: AssetData.mouse,
                os: AssetData.os,
                keyboard: AssetData.keyboard,
                monitorSize: AssetData.monitorSize,
                monitorSerial: AssetData.monitorSerial,
                cameraPixel: AssetData.cameraPixel,
                                ...
                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                    <Grid item sx={{ width: 150 }} components={['DatePicker']}>
                                        <DatePicker
                                            ...
                                            initialValue={AssetData.expiryDate}
                                        />
                                    </Grid>
                                </LocalizationProvider>
                            </Form.Item>
